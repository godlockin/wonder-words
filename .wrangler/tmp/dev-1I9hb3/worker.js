...
__name(getModelUrl, "getModelUrl");
  ...
  try {
    if (key) {
      ...
      if (res.ok) {
        ...
        console.log("[api/generate] parsed", { theme: data2?.theme, words: Array.isArray(data2?.words) ? data2.words.length : 0 });
        const words2 = (data2.words || []).map((w) => ({ ...w, id: id() }));
        return new Response(JSON.stringify({ theme: data2.theme || "Fun Words", words: words2 }), { headers: { "content-type": "application/json" } });
      }
    }
  } catch (e) {
    console.log("[api/generate] error", e);
  }
  const data = {
    theme: "Fruits",
    words: [
      { word: "apple", pronunciation: "\u02C8\xE6p\u0259l", chinese: "\u82F9\u679C", example: "I eat an apple.", exampleChinese: "\u6211\u5403\u4E00\u4E2A\u82F9\u679C\u3002" },
      { word: "banana", pronunciation: "b\u0259\u02C8n\xE6n\u0259", chinese: "\u9999\u8549", example: "Bananas are yellow.", exampleChinese: "\u9999\u8549\u662F\u9EC4\u8272\u7684\u3002" },
      ...
      { word: "pineapple", pronunciation: "\u02C8pa\u026A\u02CCn\xE6p\u0259l", chinese: "\u83E0\u841D", example: "Pineapple is juicy.", exampleChinese: "\u83E0\u841D\u5F88\u591A\u6C41\u3002" },
      { word: "cherry", pronunciation: "\u02C8t\u0283\u025Bri", chinese: "\u6A31\u6843", example: "The cherry is small.", exampleChinese: "\u6A31\u6843\u5F88\u5C0F\u3002" },
      { word: "mango", pronunciation: "\u02C8m\xE6\u014B\u0261o\u028A", chinese: "\u8292\u679C", example: "He loves mango juice.", exampleChinese: "\u4ED6\u559C\u6B22\u8292\u679C\u6C41\u3002" },
...
async function handleImage(req, env2) {
  const key = env2.API_KEY;
  try {
...
async function handleTTS(req, env2) {
  const key = env2.API_KEY;
  try {
...
// .wrangler/tmp/bundle-hoRWX8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-hoRWX8/middleware-loader.entry.ts
